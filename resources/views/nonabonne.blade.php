...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="nonabonne.css" />
...
<body>
    <header>
        ...
        <a href="connectclient.blade.php" id="logout-btn"><button class="btn"><i class="fa fa-sign-out"></i> Se déconnecter</button></a>
    </header>
    <div class="container">
